...
ref_human=$(realpath "${SCRIPT_DIR}/../../data/ref/GCF_000001405.40_GRCh38.p14_genomic.gff.gz")
ref_pk=$(realpath "${SCRIPT_DIR}/../../data/ref/GCF_000006355.2_GCA_000006355.2_genomic.gff.gz")
