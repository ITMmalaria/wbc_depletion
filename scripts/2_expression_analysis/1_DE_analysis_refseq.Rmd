...
pheatmap(sampleDistMatrix,
  ...
  main = str_wrap("Sample-to-sample Euclidian distance based on all genes - rlog", 40),
  scale = "none"
)
```
...
pheatmap(sampleDistMatrix,
  ...
  main = str_wrap("Sample-to-sample Euclidian distance based on all genes - vst", 40)
)
```
...
pheatmap(sampleDistMatrix,
  ...
  main = str_wrap("Sample-to-sample Euclidian distance based on P. knowlesi genes - rlog before subset", 40)
)
```
...
pheatmap(sampleDistMatrix,
  ...
  # main = expression(paste("Sample-to-sample Euclidian distance based on", italic("P. knowlesi"), "genes"))
  main = str_wrap("Sample-to-sample Euclidian distance based on P. knowlesi genes - vst before subset", 40)
)
```
...
pheatmap(sampleDistMatrix,
  ...
  # main = str_wrap(expression(paste("Sample-to-sample Euclidian distance based on ", italic("P. knowlesi"), " genes")))
  main = str_wrap("Sample-to-sample Euclidian distance based on P. knowlesi genes - rlog after subset", 40)
  )
```
...
pheatmap(sampleDistMatrix,
  ...
  # main = expression(paste("Sample-to-sample Euclidian distance based on ", italic("P. knowlesi"), " genes")),
  main = str_wrap("Sample-to-sample Euclidian distance based on P. knowlesi genes - vst after subset", 40)
)
```
