...
output_dir="${PROJECT_DIR}/results-refseq/fastq-screen"
fastq_screen_conf="${PROJECT_DIR}/config/fastq-screen-refseq.conf"
ref_human="${PROJECT_DIR}/data/ref-refseq-refseq/GCF_000001405.40_GRCh38.p14_genomic.fna.gz"
ref_pk="${PROJECT_DIR}/data/ref-refseq-refseq/GCF_000006355.2_GCA_000006355.2_genomic.fna"
